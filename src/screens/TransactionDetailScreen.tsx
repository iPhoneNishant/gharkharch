...
const TransactionDetailScreen: React.FC = () => {
  ...
  const handleDelete = () => {
    Alert.alert(
      'Delete Transaction',
      'Are you sure you want to delete this transaction? This will reverse the balance changes.',
      [
  ...
  if (!transaction) {
    return (
      <View style={styles.emptyState}>
        <Text style={styles.emptyStateText}>Transaction not found</Text>
      </View>
    );
  }
  ...
  return (
    ...
    >
      ...
      <View style={[styles.amountCard, { backgroundColor: typeColor }]}>
        <Text style={styles.amountLabel}>{transactionType}</Text>
      ...
      <View style={styles.flowSection}>
        <Text style={styles.sectionTitle}>Transaction Flow</Text>
        ...
        <View style={styles.flowCard}>
          ...
          >
            ...
            <View style={styles.accountInfo}>
              <Text style={styles.accountLabel}>From (Credit)</Text>
              <Text style={styles.accountName}>{creditAccount?.name ?? 'Unknown Account'}</Text>
              <Text style={styles.accountCategory}>
                {creditAccount?.subCategory ?? 'Unknown'}
              </Text>
            </View>
          ...
          >
            ...
            <View style={styles.accountInfo}>
              <Text style={styles.accountLabel}>To (Debit)</Text>
              <Text style={styles.accountName}>{debitAccount?.name ?? 'Unknown Account'}</Text>
              <Text style={styles.accountCategory}>
                {debitAccount?.subCategory ?? 'Unknown'}
              </Text>
            </View>
            <Text style={styles.chevron}>›</Text>
          </TouchableOpacity>
      ...
      <View style={styles.explanationSection}>
        ...
        <View style={styles.explanationCard}>
          ...
          <Text style={styles.explanationText}>
            • <Text style={styles.explanationBold}>Debit</Text> to{' '}
            <Text style={styles.explanationHighlight}>{debitAccount?.name ?? 'Unknown'}</Text>
            {debitAccount?.accountType === 'asset' && ' (increases asset balance)'}
            {debitAccount?.accountType === 'expense' && ' (records expense)'}
            {debitAccount?.accountType === 'liability' && ' (decreases liability)'}
          </Text>
          <Text style={styles.explanationText}>
            • <Text style={styles.explanationBold}>Credit</Text> to{' '}
            <Text style={styles.explanationHighlight}>{creditAccount?.name ?? 'Unknown'}</Text>
            {creditAccount?.accountType === 'asset' && ' (decreases asset balance)'}
            {creditAccount?.accountType === 'income' && ' (records income)'}
            {creditAccount?.accountType === 'liability' && ' (increases liability)'}
          </Text>
        </View>
      </View>
